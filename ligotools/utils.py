...
def plot_one(det, time, timemax, SNR):
    if det is 'L1': 
        pcolor='g'
...
def plot_helper(det, timemax, plottype, tevent, template_match, SNR, eventname, time,  template_fft, datafreq, d_eff, freqs, data_psd, fs):
    if det is 'L1': 
        pcolor='g'
        strain_whitenbp = strain_L1_whitenbp
        template_L1 = template_match.copy()
